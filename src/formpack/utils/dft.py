...
def dft_recurse(root:FormField, tree: dict[str, list[FormField]], process_field):
    seen = set()
    result = [root]
    seen.add(root.path)
...
def dft_recurse_inner(root:FormField, tree: dict[str, list[FormField]], process_field, result, seen):
