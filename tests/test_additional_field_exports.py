...
def test_additional_field_exports_advanced():
    ...
    assert main_export_sheet['fields'] == [
        'record_a_note',
        'record_a_note - transcript (en)',
        "record_a_note - How was the tone of the clerk's voice?/Option 1",
        "record_a_note - How was the tone of the clerk's voice?/Option 2",
        "record_a_note - How was the tone of the clerk's voice?/Option 3",
