...
def test_additional_field_exports_advanced():
    ...
    assert main_export_sheet['fields'] == [
        ...
        "record_a_note - How was the tone of the clerk's voice?/Anxious",
        "record_a_note - How was the tone of the clerk's voice?/Excited",
        "record_a_note - How was the tone of the clerk's voice?/Confused",
